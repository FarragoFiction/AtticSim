...
class Controller {
  ...
  void initRooms() {
    ...
    Player Firanka = new Player(voidRoom, "Firanka", <String>["FIRANKA", "FIRANKAMIPINSKA"], "You are now Firanka. This is absolutely ridiculous. What's that with that letter? Ń? Why?", "You attempt to use Firanka but you cannot. Firanka controls you.");
