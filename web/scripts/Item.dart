...
class Item {
    ...
    String orderDumbShit() {
        ...
        dumbShit.add(new Item("a Gundam", <String>["GUNDAM", "MOBILE SUIT", "MECHA","ROBOT", "A GUNDAM"], "YES YES YES YES YES YES YES YES YES YES YES YES YES. I WILL BUILD MY SHOGUNDAM. IT WILL FUCKING HAPPEN. I WILL DO THIS.", "You spend some time planning out your Shogundam.", portable: true));
        ...
        dumbShit.add(new Item("Statue of a Greek God Except it has KR's Head", <String>["STATUE OF A GREEK GOD EXCEPT IT HAS KR'S HEAD", "GREEK GOD", "KR","KR STATUE","GREEK GOOD STATUE"], "KR strikes fear into my soul like no other Being should. Like what does She smith? Where is the smith hammer? Is He that strong that they need only use her fists to forge the dreams? Is She that powerful he can control dreams? How buff is KR?", "You contemplate KR's theoretical buffness."));
        dumbShit.add(new Item("Map of Continential Europe", <String>["MAP OF CONTINENTIAL EUROPE", "MAP", "MAP OF EUROPE","EUROPE"], "Legends says a huge dude worshipped by japanese gamers ruled this continent. I aspire to have that level of worship.", "You admire all of Continental Europe. Besides Portugal. ", destroyable: true, portable: true));
