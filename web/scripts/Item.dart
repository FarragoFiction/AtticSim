...
class Item {
    ...
    String orderDumbShit() {
        ...
        dumbShit.add(new Item("Statue of a Greek God Except it has KR's Head", <String>["STATUE OF A GREEK GOD EXCEPT IT HAS KR'S HEAD", "GREEK GOD", "KR","KR STATUE","GREEK GOOD STATUE","STATUE"], "KR strikes fear into my soul like no other Being should. Like what does She smith? Where is the smith hammer? Is He that strong that they need only use her fists to forge the dreams? Is She that powerful he can control dreams? How buff is KR?", "You contemplate KR's theoretical buffness."));
