...
class Item {
    ...
    String orderDumbShit() {
        ...
        dumbShit.add(new Item("Gundam", <String>["GUNDAM", "MOBILE SUIT", "MECHA","ROBOT"], "YES YES YES YES YES YES YES YES YES YES YES YES YES. I WILL BUILD MY SHOGUNDAM. IT WILL FUCKING HAPPEN. I WILL DO THIS.", "You spend some time planning out your Shogundam.", portable: true));
